 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2022-01-05T17:43:30.516005Z")
public enum ConcurrencyWorkflowTasks {
	
	SLEEP_TIME_SOURCE("SleepTimeSource", true),
	SLEEPER("Sleeper", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private ConcurrencyWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static ConcurrencyWorkflowTasks fromTaskName(String taskName) {
		for (ConcurrencyWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No ConcurrencyWorkflowTasks exist with taskName " + taskName);
	}
