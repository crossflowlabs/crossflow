 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2022-01-05T17:43:32.621761Z")
public enum MatrixWorkflowTasks {
	
	MATRIX_CONFIGURATION_SOURCE("MatrixConfigurationSource", true),
	MATRIX_CONSTRUCTOR("MatrixConstructor", true),
	MATRIX_SINK("MatrixSink", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private MatrixWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static MatrixWorkflowTasks fromTaskName(String taskName) {
		for (MatrixWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No MatrixWorkflowTasks exist with taskName " + taskName);
	}
