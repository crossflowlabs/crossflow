 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2022-01-05T17:43:35.307113Z")
public enum TypeGenerationWorkflowTasks {
	
	TYPE_TASK("TypeTask", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private TypeGenerationWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static TypeGenerationWorkflowTasks fromTaskName(String taskName) {
		for (TypeGenerationWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No TypeGenerationWorkflowTasks exist with taskName " + taskName);
	}
