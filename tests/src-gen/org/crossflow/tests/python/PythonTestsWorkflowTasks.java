 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2022-01-05T17:43:34.652443Z")
public enum PythonTestsWorkflowTasks {
	...
	private PythonTestsWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static PythonTestsWorkflowTasks fromTaskName(String taskName) {
		for (PythonTestsWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No PythonTestsWorkflowTasks exist with taskName " + taskName);
	}
