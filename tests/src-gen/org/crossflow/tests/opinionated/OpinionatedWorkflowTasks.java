 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2021-10-26T15:08:26.810003Z")
public enum OpinionatedWorkflowTasks {
	
	WORD_SOURCE("WordSource", true),
	OCCURENCES_MONITOR("OccurencesMonitor", true),
	SINK("Sink", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private OpinionatedWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static OpinionatedWorkflowTasks fromTaskName(String taskName) {
		for (OpinionatedWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No OpinionatedWorkflowTasks exist with taskName " + taskName);
	}
