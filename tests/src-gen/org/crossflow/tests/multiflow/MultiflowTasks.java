 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2022-01-05T17:43:33.257764Z")
public enum MultiflowTasks {
	
	MULTI_SOURCE("MultiSource", true),
	MULTI_TASK("MultiTask", true),
	MULTI_SINK("MultiSink", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private MultiflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static MultiflowTasks fromTaskName(String taskName) {
		for (MultiflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No MultiflowTasks exist with taskName " + taskName);
	}
