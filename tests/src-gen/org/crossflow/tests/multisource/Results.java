...
@Generated(value = "org.crossflow.java.Steam2Class", date = "2022-01-05T17:43:33.629524Z")
public class Results extends JobStream<StringElement> {
	...
	public Results(Workflow<MSWorkflowTasks> workflow, boolean enablePrefetch) throws Exception {
		super(workflow);
