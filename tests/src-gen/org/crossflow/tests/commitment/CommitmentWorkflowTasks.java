 ...
 * </p>
 */
@Generated(value = "org.crossflow.java.Workflow2TaskEnum", date = "2021-10-26T15:08:23.869383Z")
public enum CommitmentWorkflowTasks {
	
	ANIMAL_SOURCE("AnimalSource", true),
	ANIMAL_COUNTER("AnimalCounter", true);
	
	private final String taskName;
	private final boolean isJavaTask;

	private CommitmentWorkflowTasks(String taskName, boolean isJavaTask) {
	 ...
	 */
	public static CommitmentWorkflowTasks fromTaskName(String taskName) {
		for (CommitmentWorkflowTasks t : values()) {
			if (t.taskName.equals(taskName)) return t;
		}
		throw new IllegalArgumentException("No CommitmentWorkflowTasks exist with taskName " + taskName);
	}
