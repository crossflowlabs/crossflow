...
public class CrossflowMetrics implements Serializable {
    ...
    public static String CSV_HEADER = "repositoryName,cacheMiss,bytesLoaded,workerId,downloadDuration,ioProcessingDuration,jobStartTime,currentLatency,job_conf,worker_conf,iteration,algorithm";
