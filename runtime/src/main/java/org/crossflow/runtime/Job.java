...
public class Job implements Serializable {
	...
	// field that will be used for user-specific uniqueness of the job
	protected String jobHash;
	private String designatedWorkerId;
	// field that will be used for calculating cost of the job
	protected double cost = 1.0;
	// field used for opinionated scheduling
	protected Set<String> rejectedByWorkerIds = ConcurrentHashMap.newKeySet();;
	...
	public void setDesignatedWorkerId(String designatedWorkerId) {
		this.designatedWorkerId = designatedWorkerId;
	}

	public String getDesignatedWorkerId() {
		return designatedWorkerId;
	}
	...
	public Set<String> getRejectedByWorkerIds() {
		return rejectedByWorkerIds;
	}

	public void rejectForWorkerId(String workerId) {
		rejectedByWorkerIds.add(workerId);
	}
}
