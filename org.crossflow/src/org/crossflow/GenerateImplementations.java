...
public class GenerateImplementations {
	...
	private static void updateManifest(File manifest) throws Exception {
		...
		if (!contents.stream().anyMatch(s -> s.contains("Require-Bundle: org.crossflow.runtime"))) {
			String dependencies = "Require-Bundle: org.crossflow.runtime";
